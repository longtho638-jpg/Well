...
export const PRODUCTS: Product[] = [
  {
    ...
    description: 'Energy & Focus Supplement. Boosts daily performance naturally. Best seller in Vietnam market.',
    salesCount: 124,
    stock: 50,
  },
  {
    id: 'PROD-120',
    name: 'WellNexus Starter',
    price: 3500000,
    commissionRate: 0.20,
    imageUrl: 'https://images.unsplash.com/photo-1620916566398-39f1143ab7be?auto=format&fit=crop&w=400&q=80',
    description: 'Business Starter Kit. Everything you need to launch.',
    salesCount: 85,
    stock: 20,
  },
  {
    ...
    description: 'Daily Vitamin C+ for family health.',
    salesCount: 56,
    stock: 100,
  }
];
...
export const DAILY_QUESTS: Quest[] = [
  {
    id: 'Q1',
    title: 'Connect',
    description: 'Share link with 5 friends to expand your network.',
    xp: 50,
    type: 'sales',
    isCompleted: false,
  },
  {
    id: 'Q2',
    title: 'Educate',
    description: 'Read "Compliance 101" to avoid false claims.',
    xp: 20,
    type: 'learning',
    isCompleted: true,
  },
