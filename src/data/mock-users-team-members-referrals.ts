/**
 * Mock data: current user, team members, referrals, and team metrics/insights
 */

import { User, UserRank, TeamMember, TeamMetrics, Referral, ReferralStats, AtRiskMember, TeamInsights } from '../types';
