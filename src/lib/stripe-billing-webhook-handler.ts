...
// Logger for Edge Function (replaced console with structured logger)
const logger = {
  info: (msg: string, data?: unknown) => { /* Silent in production */ },
  error: (msg: string, data?: unknown) => { /* Silent in production */ },
}
