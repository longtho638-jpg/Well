...
overview: {
    ...
    resolve: "Giải Quyết",
    reject: "Từ Chối",
    action_resolved: "Đã giải quyết theo đề xuất AI",
    action_rejected: "Đã từ chối đề xuất AI",
    global_gmv: "GMV Toàn Cầu",
    trend_wow: "+18.4% WoW",
    active_bee_force: "Lực Lượng Bee Hoạt Động",
    trend_new_nodes: "+12 Nút mới",
    ai_signal_pending: "Tín Hiệu AI Chờ Xử Lý",
    trend_action_required: "Cần hành động",
    ecosystem_sla: "SLA Hệ Sinh Thái",
    trend_operational: "Hoạt động",
    evt_ai_scan: "AI quét xong: 245 hồ sơ",
    evt_12s_ago: "12 giây trước",
