export const dashboard = {
  ...
  usage: {
    ...
    dashboard_subtitle: "Theo dõi mức sử dụng theo thời gian thực",
    ...
    tier_info: "Gói Dịch Vụ: {tier}",
    all_metrics: "Tất Cả Chỉ Số",
    no_usage_yet: "Chưa có dữ liệu sử dụng",
    tiers: {
      free: "Miễn Phí",
      basic: "Cơ Bản",
      premium: "Cao Cấp",
    ...
    alerts: {
      quota_warning: "Cảnh báo: Đã sử dụng {percentage}% quota",
      quota_exceeded: "Vượt quota: Nâng cấp gói để tiếp tục",
      reset_soon: "Quota sẽ đặt lại sau {time}",
    },
    actions: {
      refresh: "Làm mới",
      export: "Xuất báo cáo",
