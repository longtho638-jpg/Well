export const admin = {
  ...
  licenses: {
    ...
    metering: {
      title: "Metering & Overages",
      subtitle: "Theo dõi usage và doanh thu overage toàn hệ thống",
      export_csv: "Xuất CSV",
      date_range: "Khoảng thời gian",
      this_month: "Tháng này",
      last_month: "Tháng trước",
      custom: "Tùy chỉnh",
      usage_table: "Bảng Usage Theo Organization",
      org_name: "Tên Organization",
      plan_tier: "Gói Plan",
      api_usage: "API %",
      booking_usage: "Booking %",
      reports_usage: "Reports %",
      email_usage: "Email %",
      revenue: "Doanh Thu Overage",
      revenue_this_month: "Doanh thu overage tháng này",
      top_consumers: "Top Consumers",
      top_5_by_metric: "Top 5 organizations theo metric",
      no_data: "Chưa có dữ liệu usage",
      export_success: "Đã xuất báo cáo usage",
    },
