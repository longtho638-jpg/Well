export const team = {
  ...
  charts: {
    rankDistribution: "Charts rankDistribution",
  },
  members: {
    ...
    rank: "Members rank",
    personalSales: "Members personalSales",
    teamVolume: "Members teamVolume",
    downlines: "Members downlines",
    growth: "Members growth",
    actions: "Members actions",
  },
  filters: {
    allRanks: "Filters allRanks",
    sortSales: "Filters sortSales",
    sortGrowth: "Filters sortGrowth",
    sortTeam: "Filters sortTeam",
