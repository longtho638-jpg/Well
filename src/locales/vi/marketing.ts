export const marketing = {
  ...
  affiliate: {
    ...
    linkLabel: "Affiliate linkLabel",
    stats: {
      title: "Affiliate stats title",
      clicks: "Affiliate stats clicks",
      signups: "Affiliate stats signups",
      conversion: "Affiliate stats conversion",
      conversionValue: "Affiliate stats conversionValue",
    },
    tip: "Affiliate tip",
    qrCodeAlt: "Affiliate qrCodeAlt",
    partnerLabel: "Affiliate partnerLabel",
    downloadQR: "Affiliate downloadQR",
    share: "Affiliate share",
    qrTip: "Affiliate qrTip",
    shareTitle: "Affiliate shareTitle",
    shareText: "Affiliate shareText",
  },
  contentLibrary: {
    title: "ContentLibrary title",
    subtitle: "ContentLibrary subtitle",
    categories: {
      product: "ContentLibrary categories product",
      testimonial: "ContentLibrary categories testimonial",
      tips: "ContentLibrary categories tips",
      promotion: "ContentLibrary categories promotion",
    },
    copied: "ContentLibrary copied",
    copyText: "ContentLibrary copyText",
    downloadImage: "ContentLibrary downloadImage",
  },
  giftCards: {
    title: "GiftCards title",
    subtitle: "GiftCards subtitle",
    createNew: "GiftCards createNew",
    createTitle: "GiftCards createTitle",
    codeLabel: "GiftCards codeLabel",
    codePlaceholder: "GiftCards codePlaceholder",
    valueLabel: "GiftCards valueLabel",
    typeLabel: "GiftCards typeLabel",
    typeFixed: "GiftCards typeFixed",
    typePercentage: "GiftCards typePercentage",
    createButton: "GiftCards createButton",
    cancel: "GiftCards cancel",
    usageCount: "GiftCards usageCount",
    createdDate: "GiftCards createdDate",
  },
  title: "Title",
  subtitle: "Subtitle",
  stats: {
    giftCards: "Stats giftCards",
    contentTemplates: "Stats contentTemplates",
    affiliateLink: "Stats affiliateLink",
    active: "Stats active",
  },
  templates: {
    t1: {
      title: "Templates t1 title",
      content: "Templates t1 content",
    },
    t2: {
      title: "Templates t2 title",
      content: "Templates t2 content",
    },
    t3: {
      title: "Templates t3 title",
      content: "Templates t3 content",
    },
    t4: {
      title: "Templates t4 title",
      content: "Templates t4 content",
    },
  },
};
