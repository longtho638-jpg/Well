export const dashboard = {
  ...
  usage: {
    dashboard_title: "API & AI Usage",
    dashboard_subtitle: "Track real-time usage metrics",
    ...
    no_usage_yet: "No usage data yet",
    tiers: {
      free: "Free",
      basic: "Basic",
      premium: "Premium",
    ...
    alerts: {
      quota_warning: "Warning: {percentage}% quota used",
      quota_exceeded: "Quota exceeded: Upgrade plan to continue",
      reset_soon: "Quota resets in {time}",
    },
    actions: {
      refresh: "Refresh",
