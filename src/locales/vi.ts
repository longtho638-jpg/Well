...
export const vi = {
  ...
  liveconsole: {
    ...
    live: "TRỰC TIẾP",
    bee_agent_core_v4_2_0_stable: "BEE Agent Core v4.2.0 Ổn Định",
    bps: "bps",
    encrypted: "Đã Mã Hóa",
    lat_4ms: "Độ Trễ: 4ms",
  ...
  ordermanagement: {
    ...
    all_synced: "Đã Đồng Bộ Hết",
    cashflow_hub: "Trung Tâm Luồng Tiền",
    customer: "Khách Hàng",
    date: "Ngày",
    filters: "Bộ Lọc",
    fraud_check: "Kiểm Tra Gian Lận",
    never_approve: "Không Bao Giờ Duyệt",
    operational_risk_protocol: "Giao Thức Rủi Ro Hoạt Động",
    order: "Đơn Hàng",
    order_id: "Mã Đơn Hàng",
    order_orchestrator: "Điều Phối Đơn Hàng",
    orders: "Đơn Hàng",
    queue_synchronized: "Hàng Đợi Đã Đồng Bộ",
    real_time_order_pipeline_manag: "Quản Lý Quy Trình Đơn Hàng Thời Gian Thực",
    status: "Trạng Thái",
    ...
    without_verified_bank_clearanc: "Không Có Xác Nhận Ngân Hàng"
  },
  overview: {
    ...
    core: "Cốt Lõi",
    custom: "Tùy Chỉnh",
    identity_protocol: "Giao Thức Nhận Dạng",
    live_sync: "Đồng Bộ Trực Tiếp",
    network_foundation: "Nền Tảng Mạng Lưới",
    operational: "Hoạt Động",
    partners_active: "Đối Tác Hoạt Động",
    pending_operations: "Hoạt Động Chờ Xử Lý",
    platform_metrics: "Chỉ Số Nền Tảng",
    revenue_ytd: "Doanh Thu Từ Đầu Năm",
    ...
    ai_agent_has_autonomously_reso: "Đại lý AI đã tự động giải quyết tất cả hành động chờ xử lý.",
  ...
  products: {
    ...
    bonus_revenue_dttt_represent: "Doanh Số Thưởng DTTT Đại Diện",
    commit: "Cam Kết",
    dttt_basis: "Cơ Sở DTTT",
    dttt_commission_logic: "Công Thức Hoa Hồng DTTT",
    edit_config: "Sửa Cấu Hình",
    esc: "ESC",
    global_catalog: "Danh Mục Toàn Cầu",
    in_stock: "Còn Hàng",
    inventory_management_dttt_st: "Quản Lý Kho Hàng DTTT",
    low_stock: "Sắp Hết Hàng",
    member_21_startup_25: "Member 21% / Startup 25%",
    member_comm: "Hoa Hồng Member",
    out_of_stock: "Hết Hàng",
    partner_comm: "Hoa Hồng Partner",
    retail_msrp: "Giá Bán Lẻ (MSRP)",
    sku: "Mã SKU"
  },
  producttabs: {
  ...
  networktree: {
    ...
    i_s: "Đại sứ",
    kh_i_nghi_p: "Khởi nghiệp",
    loading_network_data: "Đang tải dữ liệu hệ thống...",
    nh_p_c_y_add_member: "Thêm thành viên mới",
    no_data_available: "Không có dữ liệu",
    password: "Mật khẩu",
    phone: "Số điện thoại",
    rank: "Cấp bậc",
    s_h_th_ng_network_tree: "Sơ đồ hệ thống",
    sales: "Doanh số",
  ...
  partnerstable: {
    ...
    ecosystem_rank: "Hạng Hệ Sinh Thái",
    ghost_network_detected: "Phát Hiện Mạng Ảo",
    identity_node: "Nút Nhận Dạng",
