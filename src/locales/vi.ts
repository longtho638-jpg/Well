import { leaderdashboard } from './vi/leaderdashboard';
...
import { achievementgrid } from './vi/achievementgrid';
import { admin } from './vi/admin';
import { adminsecuritysettings } from './vi/adminsecuritysettings';
import { agencyos } from './vi/agencyos';
import { agencyosdemo } from './vi/agencyosdemo';
import { agent } from './vi/agent';
import { agentDashboard } from './vi/agentDashboard';
import { agentdetailsmodal } from './vi/agentdetailsmodal';
import { agentgridcard } from './vi/agentgridcard';
import { airecommendation } from './vi/airecommendation';
import { analytics } from './vi/analytics';
import { app } from './vi/app';
import { auditlog } from './vi/auditlog';
import { auth } from './vi/auth';
import { beeautomationsection } from './vi/beeautomationsection';
import { billing } from './vi/billing';
import { bulkactionsbar } from './vi/bulkactionsbar';
import { button } from './vi/button';
import { cart } from './vi/cart';
import { cartdrawer } from './vi/cartdrawer';
import { chatmessage } from './vi/chatmessage';
import { chatsidebar } from './vi/chatsidebar';
import { checkout } from './vi/checkout';
import { cms } from './vi/cms';
import { commandpalette } from './vi/commandpalette';
import { commissionsection } from './vi/commissionsection';
import { commissionwallet } from './vi/commissionwallet';
import { common } from './vi/common';
import { contextsidebar } from './vi/contextsidebar';
import { copilot } from './vi/copilot';
import { copilotcoaching } from './vi/copilotcoaching';
import { copilotheader } from './vi/copilotheader';
import { copilotmessageitem } from './vi/copilotmessageitem';
import { copilotpage } from './vi/copilotpage';
import { copilotsuggestions } from './vi/copilotsuggestions';
import { cust_reset } from './vi/cust_reset';
import { dailyquesthub } from './vi/dailyquesthub';
import { dashboard } from './vi/dashboard';
import { debuggerpage } from './vi/debuggerpage';
import { div } from './vi/div';
import { dunning_stage } from './vi/dunning_stage';
import { eastasiabrand } from './vi/eastasiabrand';
import { error } from './vi/error';
import { errorboundary } from './vi/errorboundary';
import { errors } from './vi/errors';
import { exitIntent } from './vi/exitIntent';
import { finance } from './vi/finance';
import { founderrevenuegoal } from './vi/founderrevenuegoal';
import { fraudbadge } from './vi/fraudbadge';
import { healthCheck } from './vi/health-check';
import { health } from './vi/health';
import { healthCoach } from './vi/healthCoach';
import { healthcheck } from './vi/healthcheck';
import { helper } from './vi/helper';
import { herocard } from './vi/herocard';
import { heroenhancements } from './vi/heroenhancements';
import { id } from './vi/id';
import { input } from './vi/input';
import { invalid } from './vi/invalid';
import { landing } from './vi/landing';
import { last_activity } from './vi/last_activity';
import { leaderboard } from './vi/leaderboard';
import { leaderdashboard } from './vi/leaderdashboard';
import { liveActivities } from './vi/liveActivities';
import { liveactivitiesticker } from './vi/liveactivitiesticker';
import { liveconsole } from './vi/liveconsole';
import { loginactivitylog } from './vi/loginactivitylog';
import { marketing } from './vi/marketing';
import { marketingtools } from './vi/marketingtools';
import { marketplace } from './vi/marketplace';
import { marketplacefilters } from './vi/marketplacefilters';
import { marketplaceheader } from './vi/marketplaceheader';
import { max } from './vi/max';
import { misc } from './vi/misc';
import { nav } from './vi/nav';
import { network } from './vi/network';
import { networktree } from './vi/networktree';
import { nonexistent } from './vi/nonexistent';
import { notfound } from './vi/notfound';
import { notificationcenter } from './vi/notificationcenter';
import { onboardingquest } from './vi/onboardingquest';
import { orderimagemodal } from './vi/orderimagemodal';
import { ordermanagement } from './vi/ordermanagement';
import { ordertable } from './vi/ordertable';
import { overview } from './vi/overview';
import { partnerdetailmodal } from './vi/partnerdetailmodal';
import { partnerfilters } from './vi/partnerfilters';
import { partners } from './vi/partners';
import { partnerstable } from './vi/partnerstable';
import { policyEngine } from './vi/policyEngine';
...
import { productgrid } from './vi/productgrid';
import { producthero } from './vi/producthero';
import { productinfo } from './vi/productinfo';
import { productpricing } from './vi/productpricing';
import { products } from './vi/products';
import { producttabs } from './vi/producttabs';
import { profilepage } from './vi/profilepage';
import { pwa } from './vi/pwa';
import { quickactionscard } from './vi/quickactionscard';
import { quotaTracker } from './vi/quotaTracker';
import { quota_limit } from './vi/quota_limit';
import { raas } from './vi/raas';
import { rankladdersection } from './vi/rankladdersection';
import { rankprogressbar } from './vi/rankprogressbar';
import { ranks } from './vi/ranks';
import { rate_limit_config } from './vi/rate_limit_config';
import { react } from './vi/react';
import { recentactivitylist } from './vi/recentactivitylist';
import { redemptionzone } from './vi/redemptionzone';
import { referral } from './vi/referral';
import { referralqrcode } from './vi/referralqrcode';
import { resolution_method } from './vi/resolution_method';
import { resolved } from './vi/resolved';
import { revenuebreakdown } from './vi/revenuebreakdown';
import { revenuechart } from './vi/revenuechart';
import { revenueprogresswidget } from './vi/revenueprogresswidget';
import { role } from './vi/role';
import { script } from './vi/script';
import { sessionmanager } from './vi/sessionmanager';
import { settings } from './vi/settings';
import { sharebuttons } from './vi/sharebuttons';
import { sidebar } from './vi/sidebar';
import { simulationpanel } from './vi/simulationpanel';
import { statsgrid } from './vi/statsgrid';
import { subscription } from './vi/subscription';
import { success } from './vi/success';
import { successanimation } from './vi/successanimation';
import { t } from './vi/t';
import { team } from './vi/team';
import { testpage } from './vi/testpage';
import { textarea } from './vi/textarea';
import { topproducts } from './vi/topproducts';
import { total_events } from './vi/total_events';
import { total_sales } from './vi/total_sales';
import { total_usage } from './vi/total_usage';
import { transactioncard } from './vi/transactioncard';
import { useCopilot } from './vi/useCopilot';
import { useHeroCard } from './vi/useHeroCard';
import { useStatsGrid } from './vi/useStatsGrid';
import { username } from './vi/username';
import { valuationcard } from './vi/valuationcard';
import { vendor } from './vi/vendor';
import { vendor_id } from './vi/vendor_id';
import { venture } from './vi/venture';
import { wallet } from './vi/wallet';
import { withdrawal } from './vi/withdrawal';
import { withdrawalmodal } from './vi/withdrawalmodal';
...
export const vi = {
  common: {
    ...
    notSupportedYet: "[MISSING] notSupportedYet",
    currency: {
      vnd: "[MISSING] vnd",
      grow: "[MISSING] grow"
    },
    ...
    copy: "[MISSING] copy",
    chatViaZalo: "[MISSING] chatViaZalo",
    priority: {
      high: "[MISSING] high",
    ...
    hello: "[MISSING] hello",
    unknown_agent: "[MISSING] unknown agent",
    you: "[MISSING] you",
  ...
  app: {
    commission_wallet: "[MISSING] commission wallet"
  },
  agent: {
    chat: {
      active: "[MISSING] active",
      errorTitle: "[MISSING] errorTitle",
      errorMessage: "[MISSING] errorMessage"
    },
    reasoning: {
      tool: "[MISSING] tool",
      result: "[MISSING] result",
      chainTitle: "[MISSING] chainTitle"
    },
    toolcall: {
  ...
  agentdetailsmodal: {
    intelligence_node_context: "[MISSING] intelligence node context",
    enforcement: "[MISSING] enforcement"
  },
  agentDashboard: {
    strategic_objectives: "[MISSING] strategic objectives",
    operational_policies: "[MISSING] operational policies",
    operational_telemetry: "[MISSING] operational telemetry",
    inputs_data_streams: "[MISSING] inputs data streams",
    active_node: "[MISSING] active node",
    training: "[MISSING] training",
    stats: {
      totalAgents: "[MISSING] totalAgents",
      activeFunctions: "[MISSING] activeFunctions",
      customAgents: "[MISSING] customAgents"
    },
    establishingNodeSync: "[MISSING] establishingNodeSync",
    title: "[MISSING] title",
    intelligenceGridOptimal: "[MISSING] intelligenceGridOptimal",
    operationalTier: "[MISSING] operationalTier",
    version: "[MISSING] version",
    registry: "[MISSING] registry",
    nodes: "[MISSING] nodes",
    strategicSimulatorOffline: "[MISSING] strategicSimulatorOffline",
    connectToPolicyEngine: "[MISSING] connectToPolicyEngine"
  },
  agentgridcard: {
    node_id: "[MISSING] node id",
    "0x": "[MISSING] 0x",
    telemetry_stream_active: "[MISSING] telemetry stream active",
    neural_training: "[MISSING] neural training"
  },
  agentdashboard: {
    agent_ecosystem: "[MISSING] agent ecosystem",
    monitoring: "[MISSING] monitoring",
    intelligent_agents: "[MISSING] intelligent agents",
    total_agents: "[MISSING] total agents",
    active_now: "[MISSING] active now",
    total_kpis: "[MISSING] total kpis",
    total_actions: "[MISSING] total actions",
    performance: "[MISSING] performance",
    action: "[MISSING] action"
  },
  commissionwallet: {
    withdrawable_balance: "[MISSING] withdrawable balance",
    total_earnings_gross: "[MISSING] total earnings gross",
    withheld_tax_pit_10: "[MISSING] withheld tax pit 10",
    tax_compliance_mode: "[MISSING] tax compliance mode",
    wellnexus_automatically_deduct: "[MISSING] wellnexus automatically deduct",
    "10_pit": "[MISSING] 10 pit",
    for_income_exceeding_2_000_000: "[MISSING] for income exceeding 2 000 000",
    request_withdrawal: "[MISSING] request withdrawal",
    earnings_history: "[MISSING] earnings history",
    export_statement: "[MISSING] export statement",
    date_ref: "[MISSING] date ref",
    type: "[MISSING] type",
    gross_amount: "[MISSING] gross amount",
    pit_10: "[MISSING] pit 10",
    net_received: "[MISSING] net received",
    status: "[MISSING] status",
    the_bee: "[MISSING] the bee",
    source: "[MISSING] source",
    commission_calculation: "[MISSING] commission calculation",
    bonus_revenue: "[MISSING] bonus revenue",
    rate: "[MISSING] rate"
  },
  copilotcoaching: {
  ...
  copilotmessageitem: {
    copiedToClipboard: "[MISSING] copiedToClipboard",
    g_i_nhanh: "[MISSING] g i nhanh",
    copySuggestion: "[MISSING] copySuggestion"
  },
  copilotsuggestions: {
  ...
  dashboard: {
    ...
    commission: {
      ...
      breakdownSubtitle: "[MISSING] breakdownSubtitle",
      bonusRevenue: "[MISSING] bonusRevenue",
      description: "[MISSING] description"
    },
    dailyQuest: {
      title: "[MISSING] title"
  ...
  revenuebreakdown: {
    "100": "[MISSING] 100",
    total_yield: "[MISSING] total yield"
  },
  revenuechart: {
    revenue_growth: "[MISSING] revenue growth",
    last_7_days_performance: "[MISSING] last 7 days performance",
    last_7_days: "[MISSING] last 7 days",
    last_30_days: "[MISSING] last 30 days",
  ...
  leaderdashboard: {
    network_health: "[MISSING] network health",
    partner: "[MISSING] partner",
    member: "[MISSING] member",
    thanh_vien_can_ch: "[MISSING] thanh vien can ch",
    ai_phat_hien_nhung_thanh_vien: "[MISSING] ai phat hien nhung thanh vien",
    risk_levels: {
      high: "[MISSING] high",
      medium: "[MISSING] medium",
      low: "[MISSING] low"
    },
    li_do_can_ch: "[MISSING] li do can ch",
    ai_xuat: "[MISSING] ai xuat",
    goi_y_nhanh: "[MISSING] goi y nhanh",
    tong_quan_khach_lo: "[MISSING] tong quan khach lo",
    thanh_vien_rui_ro_cao: "[MISSING] thanh vien rui ro cao",
    thanh_vien_rui_ro_trung_binh: "[MISSING] thanh vien rui ro trung binh",
    ty_le_giu_chan: "[MISSING] ty le giu chan",
    can_ch: "[MISSING] can ch",
    top_3_tang_tai: "[MISSING] top 3 tang tai",
    doanh_s_cao_nhat_thang_nay: "[MISSING] doanh s cao nhat thang nay",
    doanh_s: "[MISSING] doanh s",
    doanh_s_1: "[MISSING] doanh s 1",
    doanh_s_2: "[MISSING] doanh s 2",
    status: {
      active: "[MISSING] active",
      at_risk: "[MISSING] at risk",
      inactive: "[MISSING] inactive"
    },
    ranks: {
      dai_su: "[MISSING] dai su",
      ctv: "[MISSING] ctv"
    },
    alerts: {
      reminder_success: "[MISSING] reminder success",
      reminder_failed: "[MISSING] reminder failed",
      gift_success: "[MISSING] gift success",
      gift_failed: "[MISSING] gift failed"
    },
    quan_ly_nhom: "[MISSING] quan ly nhom",
    ai_insights: "[MISSING] ai insights",
    so_huu: "[MISSING] so huu",
    all_ranks: "[MISSING] all ranks"
  },
  team: {
    charts: {
      rankDistribution: "[MISSING] rankDistribution"
    },
    members: {
      teamMembers: "[MISSING] teamMembers",
      search: "[MISSING] search",
      member: "[MISSING] member",
      rank: "[MISSING] rank",
      personalSales: "[MISSING] personalSales",
      teamVolume: "[MISSING] teamVolume",
      downlines: "[MISSING] downlines",
      growth: "[MISSING] growth",
      actions: "[MISSING] actions"
    },
    filters: {
      allRanks: "[MISSING] allRanks",
      sortSales: "[MISSING] sortSales",
      sortGrowth: "[MISSING] sortGrowth",
      sortTeam: "[MISSING] sortTeam",
      export: "[MISSING] export"
    },
    actions: {
      sendEmail: "[MISSING] sendEmail",
      call: "[MISSING] call",
      moreActions: "[MISSING] moreActions"
    },
    leaderDashboard: "[MISSING] leaderDashboard",
    subtitle: "[MISSING] subtitle",
    metrics: {
      totalMembers: "[MISSING] totalMembers",
      active: "[MISSING] active",
      teamVolume: "[MISSING] teamVolume",
      averageSales: "[MISSING] averageSales",
      topPerformers: "[MISSING] topPerformers"
    },
    description: "[MISSING] description"
  },
  leaderboard: {
    challengeTitle: "[MISSING] challengeTitle",
    challengeSubtitle: "[MISSING] challengeSubtitle",
    yourGoal: "[MISSING] yourGoal",
    motivation1: "[MISSING] motivation1",
    motivation2: "[MISSING] motivation2",
    motivation3: "[MISSING] motivation3",
    readyToFight: "[MISSING] readyToFight",
    yourPosition: "[MISSING] yourPosition",
    you: "[MISSING] you",
    keepPushing: "[MISSING] keepPushing",
    title: "[MISSING] title",
    subtitle: "[MISSING] subtitle",
    highestSales: "[MISSING] highestSales",
    topHundredPlus: "[MISSING] topHundredPlus",
    yourGrowTokens: "[MISSING] yourGrowTokens",
    noteLabel: "[MISSING] noteLabel",
    noteText: "[MISSING] noteText",
    rank: "[MISSING] rank",
    partner: "[MISSING] partner",
    shopSales: "[MISSING] shopSales",
    growToken: "[MISSING] growToken",
  ...
  nav: {
    ...
    desktop_navigation: "[MISSING] desktop navigation",
    products: "[MISSING] products",
    healthCoach: "[MISSING] healthCoach",
    partner: "[MISSING] partner",
    ventureProgram: "[MISSING] ventureProgram",
    company: "[MISSING] company",
    aboutUs: "[MISSING] aboutUs",
    careers: "[MISSING] careers",
    ventureDescription: "[MISSING] ventureDescription",
    mainNavigation: "[MISSING] mainNavigation",
    primaryNavigation: "[MISSING] primaryNavigation",
    switchToLight: "[MISSING] switchToLight",
    switchToDark: "[MISSING] switchToDark",
    darkMode: "[MISSING] darkMode",
    lightMode: "[MISSING] lightMode",
    home: "[MISSING] home",
    leaderboard: "[MISSING] leaderboard",
    marketingTools: "[MISSING] marketingTools",
    agentDashboard: "[MISSING] agentDashboard",
    healthCheck: "[MISSING] healthCheck",
    copilot: "[MISSING] copilot",
    team: "[MISSING] team",
    network: "[MISSING] network",
    withdrawal: "[MISSING] withdrawal",
    referral: "[MISSING] referral",
    settings: "[MISSING] settings",
    admin: "[MISSING] admin",
    skipToContent: "[MISSING] skipToContent"
  },
  networktree: {
    s_h_th_ng_network_tree: "[MISSING] s h th ng network tree",
    visual_representation_of_your: "[MISSING] visual representation of your",
    loading_network_data: "[MISSING] loading network data",
    no_data_available: "[MISSING] no data available",
    toast: {
      add_failed: "[MISSING] add failed"
    },
    nh_p_c_y_add_member: "[MISSING] nh p c y add member",
    sponsor: "[MISSING] sponsor",
    full_name: "[MISSING] full name",
    name_placeholder: "[MISSING] name placeholder",
    email: "[MISSING] email",
    email_placeholder: "[MISSING] email placeholder",
    phone: "[MISSING] phone",
    phone_placeholder: "[MISSING] phone placeholder",
    password: "[MISSING] password",
    password_placeholder: "[MISSING] password placeholder",
    rank: "[MISSING] rank",
    c_ng_t_c_vi_n_ctv: "[MISSING] c ng t c vi n ctv",
    kh_i_nghi_p: "[MISSING] kh i nghi p",
    i_s: "[MISSING] i s",
    add_member: "[MISSING] add member",
    sales: "[MISSING] sales",
    team: "[MISSING] team"
  },
  onboardingquest: {
    fallback_advice: "[MISSING] fallback advice",
  ...
  premiumnavigation: {
    ...
    mobileNavigation: "[MISSING] mobileNavigation",
    hot: "[MISSING] hot",
  ...
  auth: {
    login: {
      loginButton: "[MISSING] loginButton",
      backToHome: "[MISSING] backToHome",
      title: "[MISSING] title",
      subtitle: "[MISSING] subtitle",
      email: "[MISSING] email",
      password: "[MISSING] password",
      forgotPassword: "[MISSING] forgotPassword",
      hidePassword: "[MISSING] hidePassword",
      showPassword: "[MISSING] showPassword",
      rememberMe: "[MISSING] rememberMe",
      noAccount: "[MISSING] noAccount",
      signUp: "[MISSING] signUp"
    },
    password: {
      strength: {
        weak: "[MISSING] weak",
      ...
      requirements: {
        ...
        special: "[MISSING] special"
      }
    },
    register: {
      password: "[MISSING] password",
      checkEmail: "[MISSING] checkEmail",
      didntReceive: "[MISSING] didntReceive",
      resendEmail: "[MISSING] resendEmail",
  ...
  landing: {
    ...
    roadmap: {
      unlock_at: "[MISSING] unlock at",
      view_vision: "[MISSING] view vision",
      ...
      stages: {
        ...
        metropolis: {
          ...
          mission: "[MISSING] mission",
          benefits: {
            franchise: "[MISSING] franchise",
            global: "[MISSING] global",
            diversified: "[MISSING] diversified",
    ...
    trust: {
      noInventory: "[MISSING] noInventory",
      freeToJoin: "[MISSING] freeToJoin",
      certified: "[MISSING] certified",
  ...
  productcard: {
    ...
    stock: "[MISSING] stock",
    share_product_link: "[MISSING] share product link",
    share: "[MISSING] share",
    added: "[MISSING] added",
    buy_now: "[MISSING] buy now"
  },
  rankprogressbar: {
    rank_upgrade_progress: "[MISSING] rank upgrade progress",
    upgrade_to: "[MISSING] upgrade to",
    kh_i_nghi_p: "[MISSING] kh i nghi p",
    "25_commission": "[MISSING] 25 commission",
    complete: "[MISSING] complete",
    remaining: "[MISSING] remaining",
    after_upgrade: "[MISSING] after upgrade",
    "25_rate": "[MISSING] 25 rate",
    almost_there_just: "[MISSING] almost there just",
    more_to_kh_i_nghi_p_rank: "[MISSING] more to kh i nghi p rank"
  },
  referralqrcode: {
    qr_code_alt: "[MISSING] qr code alt"
  },
  sidebar: {
    coachFallback: "[MISSING] coachFallback",
    wellnexus_home: "[MISSING] wellnexus home",
    wellnexus: "[MISSING] wellnexus",
    social_commerce: "[MISSING] social commerce",
    the_coach: "[MISSING] the coach",
    day_3_30: "[MISSING] day 3 30",
    questList: "[MISSING] questList",
    xp: "[MISSING] xp",
    getAiAdviceLabel: "[MISSING] getAiAdviceLabel",
    get_ai_advice: "[MISSING] get ai advice"
  },
  venture: {
    footer: {
  ...
  wallet: {
    transactions: {
      ...
      title: "[MISSING] title",
      explorer: "[MISSING] explorer",
      date: "[MISSING] date",
      type: "[MISSING] type",
      amount: "[MISSING] amount",
      status: "[MISSING] status",
      hash: "[MISSING] hash",
      noTransactions: "[MISSING] noTransactions",
      emptyState: "[MISSING] emptyState",
      tax: "[MISSING] tax",
      viewOnBscScan: "[MISSING] viewOnBscScan"
    },
    title: "[MISSING] title",
    subtitle: "[MISSING] subtitle",
    balance: {
      ...
      this_month: "[MISSING] this month",
      shopToken: "[MISSING] shopToken",
      vnd_stablecoin: "[MISSING] vnd stablecoin",
      growToken: "[MISSING] growToken",
      governance_token: "[MISSING] governance token",
      total: "[MISSING] total",
      available: "[MISSING] available",
      locked: "[MISSING] locked",
      staked: "[MISSING] staked",
      currency: "[MISSING] currency"
    },
    stats: {
      growth_12_5: "[MISSING] growth 12 5",
      apy_12_0: "[MISSING] apy 12 0",
      apy_12_percent: "[MISSING] apy 12 percent"
    },
    staking: {
      apy: "[MISSING] apy",
      estimatedReward: "[MISSING] estimatedReward",
      rewards: "[MISSING] rewards"
    },
    actions: {
      deposit_shop: "[MISSING] deposit shop",
      withdraw: "[MISSING] withdraw",
      stake: "[MISSING] stake"
    },
    staking_tiers: "[MISSING] staking tiers",
    total_staked: "[MISSING] total staked",
    total_earned: "[MISSING] total earned",
    pending_rewards: "[MISSING] pending rewards"
  },
  withdrawal: {
    requestTitle: "[MISSING] requestTitle",
    amount: "[MISSING] amount",
    minLabel: "[MISSING] minLabel",
    bankName: "[MISSING] bankName",
    accountNumber: "[MISSING] accountNumber",
    accountName: "[MISSING] accountName",
    nameMatchNote: "[MISSING] nameMatchNote",
    selectBank: "[MISSING] selectBank",
    minAmountError: "[MISSING] minAmountError",
    insufficientBalance: "[MISSING] insufficientBalance",
    bankRequired: "[MISSING] bankRequired",
    accountNumberRequired: "[MISSING] accountNumberRequired",
    accountNameRequired: "[MISSING] accountNameRequired",
    successMessage: "[MISSING] successMessage",
    errorMessage: "[MISSING] errorMessage",
    requestSubtitle: "[MISSING] requestSubtitle",
    availableLabel: "[MISSING] availableLabel",
    submitButton: "[MISSING] submitButton",
    status: {
      cancelled: "[MISSING] cancelled"
    },
    ...
    noTransactions: "[MISSING] noTransactions",
    rejectionNote: "[MISSING] rejectionNote",
    subtitle: "[MISSING] subtitle",
    availableBalance: "[MISSING] availableBalance",
    minimumAmount: "[MISSING] minimumAmount",
    policyTitle: "[MISSING] policyTitle",
    policyDescription: "[MISSING] policyDescription"
  },
  withdrawalmodal: {
    "25": "[MISSING] 25",
    "50": "[MISSING] 50",
    "75": "[MISSING] 75",
    request_submitted: "[MISSING] request submitted",
    your_withdrawal_request_has_be: "[MISSING] your withdrawal request has be",
    processing_time_1_3_business: "[MISSING] processing time 1 3 business",
    available_balance: "[MISSING] available balance",
    enter_amount: "[MISSING] enter amount",
    max: "[MISSING] max",
    bank_account_details: "[MISSING] bank account details",
    account_number_placeholder: "[MISSING] account number placeholder",
    account_name_placeholder: "[MISSING] account name placeholder",
    processing_time: "[MISSING] processing time",
    withdrawal_requests_are_proces: "[MISSING] withdrawal requests are proces",
    cancel: "[MISSING] cancel",
    submit_request: "[MISSING] submit request",
    validation: {
      amount_required: "[MISSING] amount required",
      min_withdrawal: "[MISSING] min withdrawal",
      exceeds_balance: "[MISSING] exceeds balance",
      bank_name_required: "[MISSING] bank name required",
      account_number_required: "[MISSING] account number required",
      account_number_numeric: "[MISSING] account number numeric",
      account_name_required: "[MISSING] account name required"
    }
  },
  ...
  founderrevenuegoal: {
    m_c_ti_u_2026: "[MISSING] m c ti u 2026",
    "1_000_000_usd": "[MISSING] 1 000 000 usd",
    v_t_ti_n: "[MISSING] v t ti n",
    c_n_t_ng_t_c: "[MISSING] c n t ng t c",
    doanh_thu_hi_n_t_i: "[MISSING] doanh thu hi n t i",
    ai_xu_t_h_nh_ng: "[MISSING] ai xu t h nh ng",
    of_goal: "[MISSING] of goal"
  },
  notificationcenter: {
    notifications: "[MISSING] notifications",
    actions_required: "[MISSING] actions required",
    no_new_activity: "[MISSING] no new activity",
    we_ll_notify_you_when_somethin: "[MISSING] we ll notify you when somethin",
    clear_history: "[MISSING] clear history",
    audit_center: "[MISSING] audit center"
  },
  fraudbadge: {
  ...
  transactioncard: {
    ...
    optimal: "[MISSING] optimal",
    internal_ledger_net: "[MISSING] internal ledger net",
    gross: "[MISSING] gross",
    retention: "[MISSING] retention",
    system_yield_injected: "[MISSING] system yield injected",
    commit_approval: "[MISSING] commit approval",
    security_engine_quarantine: "[MISSING] security engine quarantine",
    flagged_for_behavioral_anomaly: "[MISSING] flagged for behavioral anomaly"
  },
  finance: {
  ...
  ordertable: {
    col_timeline: "[MISSING] col timeline",
    col_partner_identity: "[MISSING] col partner identity",
    col_value_vnd: "[MISSING] col value vnd",
    col_evidence: "[MISSING] col evidence",
    col_governance: "[MISSING] col governance",
    empty_state: "[MISSING] empty state",
    transaction_logged: "[MISSING] transaction logged",
    anonymous_partner: "[MISSING] anonymous partner",
    unverified_email: "[MISSING] unverified email",
    asset: "[MISSING] asset",
    inspect_bill: "[MISSING] inspect bill",
    no_evidence: "[MISSING] no evidence",
    approve: "[MISSING] approve"
  },
  bulkactionsbar: {
    partner: "[MISSING] partner",
    selected: "[MISSING] selected",
    activate: "[MISSING] activate",
    ban: "[MISSING] ban",
    export_csv: "[MISSING] export csv"
  },
  partnerdetailmodal: {
    update_success: "[MISSING] update success",
    update_failed: "[MISSING] update failed",
    partner_details: "[MISSING] partner details",
    edit_metrics: "[MISSING] edit metrics",
    cancel: "[MISSING] cancel",
    save_changes: "[MISSING] save changes",
    rank: "[MISSING] rank",
    total_sales: "[MISSING] total sales",
    pending_cashback: "[MISSING] pending cashback",
    point_balance: "[MISSING] point balance",
    contact_info: "[MISSING] contact info",
    email: "[MISSING] email",
    joined: "[MISSING] joined"
  },
  partnerfilters: {
    filter_all: "[MISSING] filter all",
    filter_active: "[MISSING] filter active",
    filter_banned: "[MISSING] filter banned",
    filter_dormant: "[MISSING] filter dormant",
    search_placeholder: "[MISSING] search placeholder"
  },
  partnerstable: {
    identity_node: "[MISSING] identity node",
    ecosystem_rank: "[MISSING] ecosystem rank",
    direct_yield: "[MISSING] direct yield",
    auth_pending: "[MISSING] auth pending",
    points_buffer: "[MISSING] points buffer",
    auth_status: "[MISSING] auth status",
    ops: "[MISSING] ops",
    synchronizing_crm_ledger: "[MISSING] synchronizing crm ledger",
    ghost_network_detected: "[MISSING] ghost network detected",
    no_partner_nodes_matching_curr: "[MISSING] no partner nodes matching curr"
  },
  beeautomationsection: {
    bee_engine_automation: "[MISSING] bee engine automation",
    ctv_commission_r_8: "[MISSING] ctv commission r 8",
    sponsor_bonus_amb: "[MISSING] sponsor bonus amb",
    auto_upgrade_threshold: "[MISSING] auto upgrade threshold",
    vnd_sales_ctv_startup: "[MISSING] vnd sales ctv startup"
  },
  commissionsection: {
    commission_architecture: "[MISSING] commission architecture",
    total_system_payout_threshold: "[MISSING] total system payout threshold",
    max_risk_operational_margin_c: "[MISSING] max risk operational margin c"
  },
  rankladdersection: {
    rank_migration_ladder: "[MISSING] rank migration ladder",
    target_rank: "[MISSING] target rank",
    sales_req_vnd: "[MISSING] sales req vnd",
    team_volume: "[MISSING] team volume",
    downlines: "[MISSING] downlines"
  },
  simulationpanel: {
    vc_simulation_engine: "[MISSING] vc simulation engine",
    active_distribution_node: "[MISSING] active distribution node",
    nodes: "[MISSING] nodes",
    target_aov: "[MISSING] target aov",
    monthly_fixed: "[MISSING] monthly fixed",
    ...
    strategic_forecast: "[MISSING] strategic forecast",
    strategic_candidates: "[MISSING] strategic candidates",
    partners: "[MISSING] partners",
    projected_saas_revenue: "[MISSING] projected saas revenue"
  },
  loginactivitylog: {
    login_activity: "[MISSING] login activity",
    recent_sign_in_attempts_to_you: "[MISSING] recent sign in attempts to you",
    export_activity_log: "[MISSING] export activity log",
  ...
  sessionmanager: {
    ...
    sign_out_all_others: "[MISSING] sign out all others",
    ...
    revoked_success: "[MISSING] revoked success",
    revoked_all_success: "[MISSING] revoked all success"
  },
  cart: {
    empty: "[MISSING] empty",
  ...
  chatsidebar: {
    ...
    no_history: "[MISSING] no history"
  },
  contextsidebar: {
    "15": "[MISSING] 15",
    no_patient_data: "[MISSING] no patient data",
  ...
  exitIntent: {
    benefits: {
      aiCoaching: "[MISSING] aiCoaching",
      passiveIncome: "[MISSING] passiveIncome",
      zeroRisk: "[MISSING] zeroRisk",
      premiumProducts: "[MISSING] premiumProducts"
    },
    headline: "[MISSING] headline",
    closeLabel: "[MISSING] closeLabel",
    subheadline: "[MISSING] subheadline",
    cta: "[MISSING] cta",
    urgency: "[MISSING] urgency",
    noThanks: "[MISSING] noThanks"
  },
  airecommendation: {
    "240": "[MISSING] 240",
  ...
  productgrid: {
    ...
    price: "[MISSING] price",
    commission: "[MISSING] commission",
    empty_title: "[MISSING] empty title",
    empty_message: "[MISSING] empty message"
  },
  redemptionzone: {
    categories: {
      all: "[MISSING] all",
  ...
  vendor: {
    dashboard: {
      ...
      products: {
        ...
        edit: "[MISSING] edit",
        delete: "[MISSING] delete",
        deleteConfirm: "[MISSING] deleteConfirm"
      }
    },
    analytics: {
      title: "[MISSING] title"
    ...
    addProduct: {
      validation: {
        nameRequired: "[MISSING] nameRequired",
        pricePositive: "[MISSING] pricePositive",
        commissionRange: "[MISSING] commissionRange",
        invalidUrl: "[MISSING] invalidUrl"
      },
      title: "[MISSING] title",
      name: "[MISSING] name",
      price: "[MISSING] price",
    ...
    settings: {
      subtitle: "[MISSING] subtitle",
      storeName: "[MISSING] storeName",
      storeDescription: "[MISSING] storeDescription",
      defaultDescription: "[MISSING] defaultDescription",
      saveButton: "[MISSING] saveButton"
    },
    toasts: {
      rateLimitExceeded: "[MISSING] rateLimitExceeded",
      loadError: "[MISSING] loadError",
      saveSuccess: "[MISSING] saveSuccess",
      addError: "[MISSING] addError",
      updateError: "[MISSING] updateError",
      deleteError: "[MISSING] deleteError"
    },
    errors: {
      notLoggedIn: "[MISSING] notLoggedIn",
      vendorOnly: "[MISSING] vendorOnly",
      accessDenied: "[MISSING] accessDenied"
    }
  },
  quotaTracker: {
    syncStatus: {
      pending: "[MISSING] pending",
      synced: "[MISSING] synced",
      failed: "[MISSING] failed",
      label: "[MISSING] label"
    },
    totalOverageCost: "[MISSING] totalOverageCost",
    billingPeriod: "[MISSING] billingPeriod",
    breakdownByMetric: "[MISSING] breakdownByMetric",
    transactionHistory: "[MISSING] transactionHistory",
    metric: "[MISSING] metric",
    usage: "[MISSING] usage",
    overage: "[MISSING] overage",
    cost: "[MISSING] cost",
    date: "[MISSING] date",
    noOverage: "[MISSING] noOverage",
    noOverageDescription: "[MISSING] noOverageDescription",
    upgradePrompt: "[MISSING] upgradePrompt",
    title: "[MISSING] title",
    subtitle: "[MISSING] subtitle",
    transactions: "[MISSING] transactions",
    metricsTracked: "[MISSING] metricsTracked",
    currentUsage: "[MISSING] currentUsage"
  },
  productactions: {
  ...
  commandpalette: {
    all: "[MISSING] all",
    no_commands_found: "[MISSING] no commands found",
    command_list: "[MISSING] command list",
    executing_command: "[MISSING] executing command",
    error: "[MISSING] error",
    agencyos_85_commands: "[MISSING] agencyos 85 commands",
    to_open: "[MISSING] to open"
  },
  successanimation: {
    success: "[MISSING] success"
  },
  ...
  errors: {
    ...
    network: "[MISSING] network",
    emailNotConfirmed: "[MISSING] emailNotConfirmed",
    emailAlreadyRegistered: "[MISSING] emailAlreadyRegistered",
    signupFailed: "[MISSING] signupFailed"
  },
  ranks: {
    unknown: "[MISSING] unknown"
  },
  ...
  cms: {
    ...
    tab_banners: "[MISSING] tab banners",
    tab_announcements: "[MISSING] tab announcements",
    tab_templates: "[MISSING] tab templates",
    search_placeholder: "[MISSING] search placeholder",
    loc: "[MISSING] loc",
    action: "[MISSING] action",
    link: "[MISSING] link",
    ...
    enable: "[MISSING] enable"
  },
  admin: {
    cms: {
      stat_content_banners: "[MISSING] stat content banners",
      stat_live_banners: "[MISSING] stat live banners",
      stat_broadcasts: "[MISSING] stat broadcasts",
      stat_total_templates: "[MISSING] stat total templates"
    },
  ...
  overview: {
    ...
    global_gmv: "[MISSING] global gmv",
    trend_wow: "[MISSING] trend wow",
    active_bee_force: "[MISSING] active bee force",
    trend_new_nodes: "[MISSING] trend new nodes",
    ai_signal_pending: "[MISSING] ai signal pending",
    trend_action_required: "[MISSING] trend action required",
    ecosystem_sla: "[MISSING] ecosystem sla",
    trend_operational: "[MISSING] trend operational",
    ...
    evt_ai_scan: "[MISSING] evt ai scan",
    evt_12s_ago: "[MISSING] evt 12s ago",
    evt_policy_locked: "[MISSING] evt policy locked",
    evt_2m_ago: "[MISSING] evt 2m ago",
    evt_zero_fraud: "[MISSING] evt zero fraud",
    evt_5m_ago: "[MISSING] evt 5m ago",
    risk: "[MISSING] risk",
    ai: "[MISSING] ai",
  ...
  success: {
    purchaseSuccess: "[MISSING] purchaseSuccess"
  },
  network: {
    empty_title: "[MISSING] empty title",
    empty_subtitle: "[MISSING] empty subtitle",
    manage_team_subtitle: "[MISSING] manage team subtitle",
    export_json: "[MISSING] export json",
    export_csv: "[MISSING] export csv",
    invite_member: "[MISSING] invite member",
    total_downlines: "[MISSING] total downlines",
    direct_f1: "[MISSING] direct f1",
    active_members: "[MISSING] active members",
    team_volume: "[MISSING] team volume"
  },
  notfound: {
    title: "[MISSING] title",
  ...
  profilepage: {
    joined: "[MISSING] joined",
    kyc_verified: "[MISSING] kyc verified",
    personal_information: "[MISSING] personal information",
    edit: "[MISSING] edit",
    full_name: "[MISSING] full name",
    email_address: "[MISSING] email address",
    phone_number: "[MISSING] phone number",
    date_of_birth: "[MISSING] date of birth",
    address: "[MISSING] address",
    account_status: "[MISSING] account status",
    email_verified: "[MISSING] email verified",
    security_strength: "[MISSING] security strength"
  },
  sharebuttons: {
    zalo: "[MISSING] zalo",
  ...
  settings: {
    ...
    items: {
      ...
      dark_mode_description: "Mô tả chế độ tối",
      language: "Ngôn ngữ",
      language_description: "Mô tả ngôn ngữ",
      email_notifications: "Thông báo email",
      email_notifications_description: "Mô tả thông báo email",
      push_notifications: "Thông báo push",
      push_notifications_description: "Mô tả thông báo push",
      change_password: "Đổi mật khẩu",
      change_password_description: "Mô tả đổi mật khẩu",
      two_factor: "Xác thực 2 yếu tố",
      two_factor_description: "Mô tả xác thực 2 yếu tố"
    },
    actions: {
      update: "Cập nhật",
      enable: "Kích hoạt"
  ...
  subscription: {
    ...
    toggle_billing: "[MISSING] toggle billing",
    yearly: "[MISSING] yearly",
    save_17: "[MISSING] save 17",
    current_plan: "[MISSING] current plan",
    renews: "[MISSING] renews",
    popular: "[MISSING] popular",
    year: "[MISSING] year",
    month: "[MISSING] month",
    cancel: "[MISSING] cancel",
    included: "[MISSING] included",
    downgrade: "[MISSING] downgrade",
    upgrade: "[MISSING] upgrade",
    cancel_confirm: "[MISSING] cancel confirm",
    free: "[MISSING] free"
  },
  testpage: {
