...
export const vi = {
  ...
  useHeroCard: {
    share_title: "Chia sẻ tiêu đề",
    share_text: "Chia sẻ nội dung"
  },
  errors: {
  ...
  admin: {
    ...
    licenses: {
      ...
      quota_usage: "Sử dụng hạn ngạch",
      api_calls: "API Calls",
      tokens: "Tokens",
      create_title: "Tạo License Mới",
      tier_label: "Gói License",
      quota_preset: "Giới hạn gói",
      expires_label: "Ngày hết hạn",
      user_label: "User ID (hoặc Email)",
      user_placeholder: "Nhập email user",
      user_not_found: "Không tìm thấy user với email",
      user_required: "Yêu cầu userId hoặc email",
      expires_required: "Yêu cầu ngày hết hạn",
      list_title: "Danh sách License",
      all: "Tất cả",
      no_licenses: "Không có license nào",
      status: "Trạng thái",
      actions: "Hành động",
      user: "Người dùng",
      license_key: "License Key",
      quota_limit_preview: "Giới hạn gói",
      ...
      close: "Đóng",
      success_title: "License đã tạo thành công!",
      copy_key_instruction: "Sao chép key này và gửi cho user",
      suspend_confirm: "Xác nhận tạm ngưng license",
      revoke_confirm: "Xác nhận thu hồi license",
      suspend_reason_placeholder: "Nhập lý do tạm ngưng...",
      revoke_reason_placeholder: "Nhập lý do thu hồi...",
      cancel: "Hủy",
      enter_suspend_reason: "Nhập lý do tạm ngưng",
      enter_revoke_reason: "Nhập lý do thu hồi",
      page_description: "Quản lý license keys, kích hoạt, thu hồi và xem audit logs",
      status_active: "Hoạt động",
      status_expired: "Hết hạn",
      status_revoked: "Thu hồi",
