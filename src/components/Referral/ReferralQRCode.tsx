...
export const ReferralQRCode: React.FC<ReferralQRCodeProps> = ({ qrCodeUrl, onDownload }) => (
    ...
    >
        <div className="flex items-center justify-center gap-6 mb-10">
            ...
            <h3 className="text-2xl font-black text-white italic tracking-tighter uppercase">Visual ID Key</h3>
        </div>
        ...
        <div className="bg-white rounded-[2rem] p-8 shadow-2xl inline-block mb-10 group relative">
            ...
            <div className="mt-6 text-center relative z-10">
                <p className="text-[10px] font-black text-zinc-950 uppercase tracking-[0.3em] mb-1 italic">WellNexus Network</p>
                <p className="text-[8px] font-bold text-zinc-500 uppercase tracking-widest leading-none">Scanning initiates sync</p>
            </div>
        </div>
        ...
        <p className="text-[9px] font-black text-zinc-500 uppercase tracking-[0.2em] mt-6 italic">
            Recommended for high-conversion physical marketing collateral.
        </p>
    </motion.div>
);
