...
interface GiftCardSectionProps {
  giftCards: GiftCard[];
  onCreateCard: (card: Omit<GiftCard, 'id' | 'usageCount' | 'createdAt'>) => void;
}

/**
 * Gift card management section for marketing campaigns
 * Allows creating and displaying promotional gift cards
 */
export default function GiftCardSection({ giftCards, onCreateCard }: GiftCardSectionProps) {
