  ...
  return (
    <>
      ...
      >
        ...
        <p className="text-gray-400 text-[10px] uppercase font-bold tracking-widest mb-1">Personal Sales</p>
      ...
      >
        ...
        <p className="text-gray-400 text-[10px] uppercase font-bold tracking-widest mb-1">Team Volume</p>
      ...
      <motion.div 
        ...
        className="bg-brand-dark p-6 rounded-2xl shadow-lg text-white relative overflow-hidden group border border-gray-800"
      >
        {/* Decorative BG */}
        <div className="absolute right-0 top-0 w-24 h-24 bg-brand-primary opacity-20 rounded-bl-full transition-transform group-hover:scale-110"></div>
        
        <div className="flex justify-between items-start mb-4 relative z-10">
            <div className="w-10 h-10 bg-white/10 rounded-xl flex items-center justify-center text-brand-accent backdrop-blur-sm border border-white/5">
                <CalendarClock className="w-5 h-5" />
            </div>
            <div className="text-right">
                <p className="text-gray-400 text-[10px] uppercase font-bold tracking-widest">Pay Date</p>
                <p className="font-bold text-brand-accent text-sm">{user.nextPayoutDate || 'TBD'}</p>
            </div>
        </div>

        <div className="relative z-10">
            <p className="text-gray-400 text-[10px] uppercase font-bold tracking-widest mb-1">Est. Gross Bonus</p>
            <h3 className="text-2xl font-bold text-white mb-2">{formatVND(estimatedBonus)}</h3>
