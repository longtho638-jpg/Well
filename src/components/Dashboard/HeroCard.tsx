        ...
        <div className="relative z-10 p-8 flex flex-col md:flex-row justify-between items-end gap-8">
            <div className="flex-1 w-full">
                ...
                <div className="flex items-center gap-2 mb-3">
                    ...
                    <span className="text-teal-200/80 text-xs font-medium">Day 12 of 30</span>
                </div>
                
                <h2 className="text-3xl font-bold mb-3 text-white tracking-tight">Road to Founder Club</h2>
                <p className="text-teal-100 text-sm mb-8 max-w-lg leading-relaxed opacity-90">
                    Hit <span className="font-bold text-white">100M Team Volume</span> to unlock the "Founder" badge and receive 2% Global Bonus Pool sharing.
                </p>

                {/* Progress Section */}
                <div className="mb-2 flex justify-between items-end text-xs font-semibold uppercase tracking-wide">
                    <span className="text-teal-200">Current Progress</span>
                ...
                <p className="text-xs text-teal-200">
                    <span className="text-white font-bold">{formatVND(remaining)}</span> until next rank
                </p>
            </div>
            ...
            <div className="w-full md:w-auto bg-white/10 backdrop-blur-md border border-white/10 p-5 rounded-2xl min-w-[280px] transition-transform hover:translate-y-[-2px]">
                <div className="flex justify-between items-center mb-2">
                    <p className="text-teal-200 text-[10px] uppercase font-bold tracking-widest">Your Referral Link</p>
