        ...
        <div className="bg-gradient-to-br from-amber-500/10 to-transparent border border-amber-500/20 p-8 rounded-[2.5rem] shadow-2xl relative overflow-hidden group">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 relative z-10">
                <div className="space-y-6">
                    <div>
                        <div className="flex justify-between mb-3 px-1">
                            <label className="text-[10px] font-black uppercase tracking-widest text-zinc-500">CTV COMMISSION (R-8)</label>
                    ...
                    <div>
                        <div className="flex justify-between mb-3 px-1">
                            <label className="text-[10px] font-black uppercase tracking-widest text-zinc-500">Sponsor Bonus (AMB+)</label>
                ...
                <div className="bg-zinc-950/50 p-6 rounded-3xl border border-white/5 space-y-4">
                    <label className="block text-[10px] font-black uppercase tracking-widest text-zinc-500">Auto-Upgrade Threshold</label>
                    <div className="text-3xl font-black text-white tracking-widest font-mono">
                        ...
                        />
                        <div className="text-[10px] text-amber-500 mt-2">VND SALES (CTV → STARTUP)</div>
                    </div>
                </div>
            </div>
        </div>
