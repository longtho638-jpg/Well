    ...
    return (
        <div className="mb-12">
            ...
            >
                ...
                <span className="text-[10px] font-black text-emerald-500 uppercase tracking-[0.3em] italic">{t('productinfo.bio_optic_optimization')}</span>
            </motion.div>
            ...
            <div className="flex flex-wrap items-center gap-8 mb-10">
                <div className="flex items-center gap-3">
                    ...
                    <span className="text-xs font-black text-white italic tracking-widest uppercase">{t('productinfo.4_9_core_rating')}</span>
                </div>
                <div className="w-1.5 h-1.5 rounded-full bg-zinc-800" />
                <div className="text-xs text-emerald-500 font-black flex items-center gap-3 uppercase tracking-widest italic">
                    <CheckCircle className="w-4 h-4" /> {t('productinfo.available_capacity')}{product.stock} {t('productinfo.units')}</div>
            </div>
