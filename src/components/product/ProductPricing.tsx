        ...
        <div className="bg-zinc-900 border border-white/5 rounded-[3rem] p-10 mb-12 shadow-2xl group relative overflow-hidden">
            ...
            <div className="grid grid-cols-2 gap-10 relative z-10">
                <div className="space-y-3">
                    <p className="text-[10px] font-black text-zinc-600 uppercase tracking-[0.4em] italic mb-1">{t('productpricing.market_valuation')}</p>
                    <p className="text-4xl font-black text-white tracking-tighter italic">{formatVND(product.price)}</p>
                </div>
                <div className="space-y-3 text-right">
                    <p className="text-[10px] font-black text-teal-400 uppercase tracking-[0.4em] italic mb-1">{t('productpricing.node_yield_profit')}</p>
