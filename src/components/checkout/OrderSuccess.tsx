    ...
    return (
        <div className="min-h-screen bg-zinc-50 dark:bg-black flex items-center justify-center p-6">
            <div className="max-w-md w-full bg-white dark:bg-zinc-900 rounded-[2.5rem] p-10 text-center shadow-2xl border border-zinc-200 dark:border-white/5">
                ...
                <h1 className="text-3xl font-black text-zinc-900 dark:text-white mb-4">Đặt hàng thành công!</h1>
                <p className="text-zinc-500 dark:text-zinc-400 mb-8 leading-relaxed">
                    Cảm ơn bạn đã mua hàng tại WellNexus. Chúng tôi sẽ liên hệ với bạn sớm nhất để xác nhận đơn hàng.
                </p>
