...
export default function LandingRoadmapSection({
  ...
  return (
    <section id="roadmap" className="relative py-16 md:py-32 bg-zinc-950">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12">
        ...
        >
          ...
          <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black text-zinc-100 mb-4 md:mb-6">
            ...
            return (
              <motion.div
                ...
                className={`
                  ...
                  md:hover:scale-105 hover:shadow-2xl hover:shadow-${stage.color}-500/20
                `}
              >
