  ...
  if (isLoading) {
    return (
      <div className="min-h-screen bg-zinc-950 flex flex-col items-center justify-center p-6 space-y-4">
        ...
        <p className="text-[10px] font-black text-zinc-500 uppercase tracking-[0.4em] italic animate-pulse">Establishing Node Sync...</p>
      </div>
    );
  }
        ...
        >
              ...
              <div>
                ...
                <div className="flex items-center gap-4 mt-2">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-[10px] font-black text-emerald-400 uppercase tracking-[0.2em] italic">Intelligence Grid Optimal</span>
                  </div>
                  <span className="text-zinc-800">/</span>
                  <span className="text-[10px] font-black text-zinc-500 uppercase tracking-[0.2em] italic">
                    Operational Tier: {userRole.toUpperCase()}
                  </span>
                </div>
              </div>
            </div>
          ...
          <div className="flex flex-wrap items-center gap-4">
            ...
            <div className="flex items-center gap-4 bg-zinc-900/50 border border-white/5 px-6 py-4 rounded-2xl">
              ...
              <span className="text-xs font-black text-zinc-300 font-mono italic uppercase tracking-widest leading-none">v1.2.0-STABLE</span>
            </div>
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="relative z-10 flex flex-col items-center gap-6">
            ...
            <div className="space-y-2">
              <h3 className="text-2xl font-black text-white italic tracking-tighter uppercase">Strategic Simulator Offline</h3>
              <p className="text-zinc-500 text-xs font-black uppercase tracking-widest max-w-md mx-auto leading-relaxed">
                Connect to the Policy Engine registry to simulate mass market scenarios and optimize rank-up triggers.
              </p>
            </div>
          </div>
        </motion.div>
