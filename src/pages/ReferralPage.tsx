        ...
        >
          ...
          <div className="bg-white rounded-xl p-4 flex items-center gap-3 mb-6 shadow-md border-2 border-primary/20">
            ...
            <motion.button
              ...
              className="px-5 py-2.5 bg-gradient-to-r from-primary to-teal-600 hover:shadow-lg text-white rounded-lg flex items-center gap-2 transition-all font-semibold"
            >
              {copiedLink ? (
                <>
          ...
          <motion.button
            ...
            className="w-full px-6 py-4 bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 text-white rounded-xl flex items-center justify-center gap-3 transition-all shadow-lg font-bold text-lg group"
          >
