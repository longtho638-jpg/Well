/**
 * Admin Mobile Drawer — slide-in nav overlay for small screens
 */
...
interface AdminSidebarMobileDrawerProps {
  open: boolean;
  onClose: () => void;
  navItems: NavItem[];
...
export const AdminSidebarMobileDrawer: React.FC<AdminSidebarMobileDrawerProps> = ({
  open,
  onClose,
  navItems,
  isActive,
          ...
          >
            <div className="h-24 border-b border-white/5 flex items-center justify-between px-8">
              <div className="flex items-center gap-4">
                ...
                <h1 className="font-black text-white uppercase italic tracking-tighter text-lg">
                  {t('admin.mission_control')}
                </h1>
              </div>
              <button
                onClick={onClose}
              ...
              {navItems.map((item) => {
                ...
                return (
                  ...
                  >
                    ...
                    <span className="font-black text-[11px] uppercase tracking-[0.2em] italic">
                      {item.label}
                    </span>
                    {item.badge && (
                      <span
                        className={`ml-auto px-2 py-0.5 text-[9px] font-black rounded-lg border ${
                          active
