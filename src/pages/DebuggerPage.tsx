    ...
    <div className="min-h-screen bg-gray-900 text-white pt-20 px-4 font-mono">
      <div className="max-w-6xl mx-auto">
        <div className="flex justify-between items-center mb-8">
          <h1 className="text-3xl font-bold text-blue-400">System Debugger</h1>
          <div className="text-xs text-gray-400">v.Debug.1.0</div>
        </div>

        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          {/* Store State */}
          <div className="bg-gray-800 rounded-lg border border-gray-700 p-6">
            <h2 className="text-xl font-semibold mb-4 text-green-400">Zustand Store State</h2>
          ...
          {/* Environment Info */}
          <div className="bg-gray-800 rounded-lg border border-gray-700 p-6">
             <h2 className="text-xl font-semibold mb-4 text-purple-400">Environment & Window</h2>
             <div className="space-y-4">
               <div>
                 <h3 className="text-sm text-gray-400 mb-2">Window Props</h3>
               ...
               <div>
                  <h3 className="text-sm text-gray-400 mb-2">Local Storage Keys</h3>
                  <div className="bg-black rounded p-3 text-xs text-yellow-300">
                    ...
                    {Object.keys(localStorage).length === 0 && <span className="opacity-50">Empty</span>}
                  </div>
               </div>
             </div>
          </div>
